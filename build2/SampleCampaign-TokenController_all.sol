...
contract TokenController {
    /// @notice Called when `_owner` sends ether to the MagicCube Token contract
...
//File: contracts/MagicCubeToken.sol
pragma solidity ^0.4.18;
...
contract MagicCubeToken is Controlled {

    string public name;                //The Token's name: e.g. DigixDAO Tokens
    uint8 public decimals;             //Number of decimals of the smallest unit
    string public symbol;              //An identifier: e.g. REP
    string public version = "0.1"; //   An arbitrary versioning scheme
    ...
    MagicCubeToken public parentToken;
    ...
    MagicCubeTokenFactory public tokenFactory;

////////////////
// Constructor
////////////////

    /// @notice Constructor to create a MagicCubeToken
    /// @param _tokenFactory The address of the MagicCubeTokenFactory contract that
    ...
    function MagicCubeToken(
        ...
        tokenFactory = MagicCubeTokenFactory(_tokenFactory);
        name = _tokenName;                                 // Set the name
        decimals = _decimalUnits;                          // Set the decimals
        symbol = _tokenSymbol;                             // Set the symbol
        parentToken = MagicCubeToken(_parentToken);
...
////////////////
    ...
    /// @return The address of the new MagicCubeToken Contract
    function createCloneToken(
        ...
        MagicCubeToken cloneToken = tokenFactory.createCloneToken(
            this,
            _snapshotBlock,
            _cloneTokenName,
            _cloneDecimalUnits,
...
//////////
    ...
    function claimTokens(address _token) public onlyController {
        ...
        MagicCubeToken token = MagicCubeToken(_token);
...
////////////////
// MagicCubeTokenFactory
////////////////

/// @dev This contract is used to generate clone contracts from a contract.
///  In solidity this is the way to create a contract from a contract of the
///  same class
contract MagicCubeTokenFactory {
    ...
    function createCloneToken(
        ...
        string _tokenSymbol,
        bool _transfersEnabled
    ) public returns (MagicCubeToken) {
        MagicCubeToken newToken = new MagicCubeToken(
            this,
            _parentToken,
            _snapshotBlock,
            _tokenName,
...
/// @author Jordi Baylina
/// @dev This contract controls the issuance of tokens for the MagicCube Token
...
/// @dev This is designed to control the issuance of a MagicCube Token for a
...
contract Campaign is TokenController, Owned {
    ...
    MagicCubeToken public tokenContract;   // The new token for this Campaign
...
/// @param _tokenAddress Address of the token contract this contract controls
    ...
    function Campaign(
        ...
        tokenContract = MagicCubeToken(_tokenAddress);// The Deployed Token Contract
